...
~~~
$ git clone https://github.com/vlad/variants.git ~/Desktop/vlad-variants
~~~
{: .language-bash}
...
~~~
Whoa, this one also contains E484K.
~~~
{: .output}

~~~
$ git add b1351.txt
$ git commit -m "Add notes about B.1.351"
~~~
{: .language-bash}

~~~
 [main 66752c2] Add notes about B.1.351
 1 file changed, 1 insertion(+)
 create mode 100644 b1351.txt
~~~
{: .output}
